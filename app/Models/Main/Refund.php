 ...
 * Class Refund
 */
class Refund extends ModelDBMain
{
    ...
    public function getRoute()
    {
        ...
        return "/refunds/{$this->public_id}/edit";
    }
    ...
    {
        return $this->hasMany('App\Models\Main\RefundItem');
    }
    ...
    {
        return $this->is_recurring ? trans('texts.recurring') : $this->refund_number;
    }
    ...
    public function getFileName()
    {
        ...
        return trans("texts.$entityType") . '_' . $this->refund_number . '.pdf';
    }
