...
class StateResultsHistory extends ModelDBMain
{

    protected $connection = 'main';
    protected $table = 'state_result_history';
    ...
    public function state_result()
    {
        return $this->belongsTo('App\Models\Main\StateResults', 'state_result_id', 'id');
    }
}
