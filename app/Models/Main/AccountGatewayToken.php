 ...
 */
class AccountGatewayToken extends ModelDBMain
{
    ...
    {
        return $this->hasMany('App\Models\Main\PaymentMethod');
    }
    ...
    {
        return $this->belongsTo('App\Models\Main\AccountGateway');
    }
    ...
    {
        return $this->hasOne('App\Models\Main\PaymentMethod', 'id', 'default_payment_method_id');
    }
